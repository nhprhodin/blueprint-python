...
def main():
    ...
    parser.add_argument('-c', '--config', dest='config', required=True, help='Path to config file.')
    parser.add_argument('-l', '--loglevel', dest='log_level', required=False, default='INFO', type=_log_level_options,
